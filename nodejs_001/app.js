 ...
 * 
 * 이처럼 모듈을 import 하면 프로젝트에서는 이들을
 *  middle ware가 설정되었다 라고 한다.
 */
...
// localhost:3000/ 요청이오면
// ./routest 폴더에 있는 index.js 파일을 실행하여
// 요청을 처리하라
...
// 쉽게 지정을 할 수 있다.
// 지금현재는 운영체제에 무관하게 path(폴더경로)를
// 슬래시(/)를 사용하지만
// 과거에는 윈도우에서는 역슬래시(\)를 사용하고
//    Unix(linux, mac) 등에서는 슬래시를 사용하여만
//    했던 시절이 있다
